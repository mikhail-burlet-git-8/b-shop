        ...
        <div class="container">
            ...
            <section class="mt-16 lg:mt-24">
                ...
                <div class="products grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-x-8 gap-y-8 lg:gap-y-10 2xl:gap-y-12 mt-8">
                    ...
                    <div class="product-card flex flex-col rounded-3xl bg-card">
                        <a href="product.html" class="product-card-photo overflow-hidden h-[320px] rounded-3xl">
                            <img src="./images/products/2.jpg" class="object-cover w-full h-full" alt="SteelSeries Sensei Ten">
                        </a>
                        <div class="grow flex flex-col py-8 px-6">
                    ...
                    <div class="product-card flex flex-col rounded-3xl bg-card">
                        <a href="product.html" class="product-card-photo overflow-hidden h-[320px] rounded-3xl">
                            <img src="./images/products/3.jpg" class="object-cover w-full h-full" alt="Logitech G PRO Mechanical Gaming Keyboard RU">
                        </a>
                        <div class="grow flex flex-col py-8 px-6">
                            <h3 class="text-sm lg:text-md font-black"><a href="product.html" class="inline-block text-white hover:text-pink">Logitech G PRO Mechanical Gaming Keyboard RU</a></h3>
                            <div class="mt-auto pt-6">
                                ...
                                <div class="flex flex-wrap items-center gap-4">
                                    <a href="#" class="w-[56px] !h-[56px] !px-0 btn btn-pink">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" viewBox="0 0 52 52">
                                            <path fill-rule="evenodd" d="M51.38 6.692c.481.442.514 1.19.073 1.67l-33.8 36.873a1.182 1.182 0 0 1-1.707.037L.582 29.908a1.182 1.182 0 1 1 1.672-1.67l14.49 14.49L49.712 6.765a1.182 1.182 0 0 1 1.67-.073Z" clip-rule="evenodd"/>
                                        </svg>
                                    </a>
                                    <a href="#" class="w-[56px] !h-[56px] !px-0 btn btn-purple" title="В избранное">
                                        <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 52 52">
                    ...
                    <div class="product-card flex flex-col rounded-3xl bg-card">
                        <a href="product.html" class="product-card-photo overflow-hidden h-[320px] rounded-3xl">
                            <img src="./images/products/4.jpg" class="object-cover w-full h-full" alt="Монитор LG 27 27GL650F-B">
                        </a>
                        <div class="grow flex flex-col py-8 px-6">
                            <h3 class="text-sm lg:text-md font-black"><a href="product.html" class="inline-block text-white hover:text-pink">Монитор LG 27 27GL650F-B</a></h3>
                            <div class="mt-auto pt-6">
                    ...
                    <div class="product-card flex flex-col rounded-3xl bg-card">
                        ...
                        <div class="grow flex flex-col py-8 px-6">
                            <h3 class="text-sm lg:text-md font-black"><a href="product.html" class="inline-block text-white hover:text-pink">SteelSeries Arctis 5 White 2019 Edition</a></h3>
                            <div class="mt-auto pt-6">
                    ...
                    <div class="product-card flex flex-col rounded-3xl bg-card">
                        <a href="product.html" class="product-card-photo overflow-hidden h-[320px] rounded-3xl">
                            <img src="./images/products/6.jpg" class="object-cover w-full h-full" alt="Razer Goliathus Chroma">
                        </a>
                        <div class="grow flex flex-col py-8 px-6">
                            <h3 class="text-sm lg:text-md font-black"><a href="product.html" class="inline-block text-white hover:text-pink">Razer Goliathus Chroma</a></h3>
                            <div class="mt-auto pt-6">
                    ...
                    <div class="product-card flex flex-col rounded-3xl bg-card">
                        <a href="product.html" class="product-card-photo overflow-hidden h-[320px] rounded-3xl">
                            <img src="./images/products/7.jpg" class="object-cover w-full h-full" alt="Hator Rockfall EVO TKL Optical White">
                        </a>
                        <div class="grow flex flex-col py-8 px-6">
                            <h3 class="text-sm lg:text-md font-black"><a href="product.html" class="inline-block text-white hover:text-pink">Hator Rockfall EVO TKL Optical White</a></h3>
                            <div class="mt-auto pt-6">
                    ...
                    <div class="product-card flex flex-col rounded-3xl bg-card">
                        <a href="product.html" class="product-card-photo overflow-hidden h-[320px] rounded-3xl">
                            <img src="./images/products/8.jpg" class="object-cover w-full h-full" alt="Razer Raiju Tournament Edition Bluetooth Quartz">
                        </a>
                        <div class="grow flex flex-col py-8 px-6">
                            <h3 class="text-sm lg:text-md font-black"><a href="product.html" class="inline-block text-white hover:text-pink">Razer Raiju Tournament Edition Bluetooth Quartz</a></h3>
                            <div class="mt-auto pt-6">
                    ...
                    <div class="product-card flex flex-col rounded-3xl bg-card">
                        ...
                        <div class="grow flex flex-col py-8 px-6">
                            <h3 class="text-sm lg:text-md font-black"><a href="product.html" class="inline-block text-white hover:text-pink">Hator Hypersport V2 (HTC-948) Black/White</a></h3>
                            <div class="mt-auto pt-6">
